...
**Novedades en v1.5.6:**
- **Pantalla virtual (modo DeX)**: escritorio virtual independiente del teléfono, con su propia resolución, al estilo Samsung DeX
...
- **Resolución y DPI configurables**: de 720p a 4K y DPI 160 / 240 / 320 o personalizado, como en un emulador
 ...
 *Esta es una pre-release. La versión estable sigue siendo la **v1.4.5**.*
...
| Windows 10/11 x64 (recomendado) | [LyXel_Setup_v1.4.5.exe](https://github.com/sudoNks/Lyxel/releases/download/v1.4.5/LyXel_Setup_v1.4.5.exe) |

| Windows 10 x86 (32 bits) | [LyXel_Setup_v1.4.5.exe](https://github.com/sudoNks/Lyxel/releases/download/v1.4.5/LyXel_Setup_v1.4.5.exe) |
...
**Nota:** esta edición no incluye el Mapeador, disponible solo en LyXel para Windows.
...
| v0.3.8-debugfix | Error conocido: muestra consola de Pygame. Se conserva por historial | [Download](https://github.com/sudoNks/Lyxel/releases/tag/v0.3.8-debugfix) |
...
## Licencia
    ...
    LyXel is free to use for personal, non-commercial purposes.

    Redistribution, modification, or commercial use of this software
    or any of its components is not permitted without explicit written
    permission from the author.

    The source code of this project is proprietary and not publicly available.
